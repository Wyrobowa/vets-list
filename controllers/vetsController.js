...
const editVet = async (req, res, next) => {
    ...
    const tags = await Tag.find();
    if (!vet) return next();
    res.render('edit', { title: 'Edit Vet: ' + vet.name, vet, tags, formAction: `/vet/${vet.slug}/edit` })
};
...
module.exports = { homePage, getVets, getVetBySlug, addVet, createVet, editVet, updateVet, getTop };
